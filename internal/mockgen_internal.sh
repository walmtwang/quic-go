...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/walmtwang/quic-go/internalpackage
...
cp -r $GOPATH/src/github.com/walmtwang/quic-go/internal/* $TEMP_DIR/src/github.com/walmtwang/quic-go/internalpackage
